//
//  BaseAlbumsViewController.swift
//  LastFM
//
...
class BaseAlbumsViewController: UIViewController {
    ...
    func showLoadingMoreView() -> Void {
        ...
        albumsTableView.tableFooterView = paginationIndicator
    }
...
extension BaseAlbumsViewController: UITableViewDataSource {
...
extension BaseAlbumsViewController: UITableViewDelegate {
